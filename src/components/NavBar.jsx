    ...
    <nav className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 lg:w-[1000px]">
        <div className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="./public/Logo.png" className="h-8" alt="" />
        ...
        <div className="flex md:order-2">
          <button
            ...
            aria-expanded="false"
            className="md:hidden text-black dark:text-gray-400 hover:bg-gray-10 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1"
          >
        ...
        <div className={`items-end w-full md:flex md:w-auto md:order-1 ${isOpen ? 'block' : 'hidden'}`} id="navbar-search">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="/"
                className="block py-2 px-3 text-black rounded md:bg-transparent md:text-[#CDA274] md:p-0 md:dark:text-[#CDA274] font-light transition-colors duration-300"
                aria-current="page"
              >
                Home
              </a>
